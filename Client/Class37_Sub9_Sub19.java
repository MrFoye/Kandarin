...
public class Class37_Sub9_Sub19 extends Class37_Sub9 {
	...
	public static RSString aClass16_3253 = Class37_Sub2.crateRSString((byte) 108,
			":clan:");
	public static RSString aClass16_3254 = Class37_Sub2.crateRSString((byte) 107,
		...
		do {
			if (Class37_Sub9_Sub28.anInt3440 == 1) {
				...
				if (i_0_ > Class33.anInt764
						|| (i_0_ - -14 ^ 0xffffffff) > (Class33.anInt764 ^ 0xffffffff)
						|| (Class37_Sub13.anInt2113 ^ 0xffffffff) > -5
						|| (Class37_Sub13.anInt2113 ^ 0xffffffff) < -19) {
					if ((i_0_ + 15 ^ 0xffffffff) >= (Class33.anInt764 ^ 0xffffffff)
							&& (i_0_ + 80 ^ 0xffffffff) <= (Class33.anInt764 ^ 0xffffffff)
							&& Class37_Sub13.anInt2113 >= 4
							&& (Class37_Sub13.anInt2113 ^ 0xffffffff) >= -19) {
				...
				if ((Class33.anInt764 ^ 0xffffffff) <= (i_1_ ^ 0xffffffff)
						&& (i_1_ + 14 ^ 0xffffffff) <= (Class33.anInt764 ^ 0xffffffff)
						&& (Class37_Sub13.anInt2113 ^ 0xffffffff) <= -5
						&& Class37_Sub13.anInt2113 <= 18) {
					Class82.method1308(1, (byte) 89, 0);
					break;
				}
				if ((i_1_ - -15 ^ 0xffffffff) >= (Class33.anInt764 ^ 0xffffffff)
						&& (i_1_ + 80 ^ 0xffffffff) <= (Class33.anInt764 ^ 0xffffffff)
						&& Class37_Sub13.anInt2113 >= 4
						&& (Class37_Sub13.anInt2113 ^ 0xffffffff) >= -19) {
				...
				if (Class33.anInt764 >= i_2_
						&& (Class33.anInt764 ^ 0xffffffff) >= (14 + i_2_ ^ 0xffffffff)
						&& Class37_Sub13.anInt2113 >= 4
						&& Class37_Sub13.anInt2113 <= 18) {
					Class82.method1308(2, (byte) 99, 0);
					break;
				}
				if ((Class33.anInt764 ^ 0xffffffff) <= (i_2_ + 15 ^ 0xffffffff)
						&& (Class33.anInt764 ^ 0xffffffff) >= (i_2_ + 80 ^ 0xffffffff)
						&& (Class37_Sub13.anInt2113 ^ 0xffffffff) <= -5
						&& Class37_Sub13.anInt2113 <= 18) {
				...
				if (Class33.anInt764 >= i_3_
						&& (14 + i_3_ ^ 0xffffffff) <= (Class33.anInt764 ^ 0xffffffff)
						&& (Class37_Sub13.anInt2113 ^ 0xffffffff) <= -5
						&& (Class37_Sub13.anInt2113 ^ 0xffffffff) >= -19) {
				...
				if (i_3_ - -15 <= Class33.anInt764
						&& (Class33.anInt764 ^ 0xffffffff) >= (80 + i_3_ ^ 0xffffffff)
						&& Class37_Sub13.anInt2113 >= 4
						&& Class37_Sub13.anInt2113 <= 18) {
				...
				if ((Class37_Sub9_Sub17.anInt3218 ^ 0xffffffff) != 0) {
					...
					if (Class37_Sub4_Sub13.aBoolean2791 != !class56.aBoolean1082) {
						byte[] is = Class37_Sub9_Sub27
								...
								.method179((byte) -103);
						Class37_Sub8.aString1940 = new String(is, 0, is.length);
						...
						RSString rSString = (Class37_Sub9_Sub27.method881(i
								^ ~0x3534, (new RSString[] {
		...
		try {
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == 0) {
				...
				Class37_Sub9_Sub17.anInt3225 = Class83.byteVector
						.method986(7);
				ByteVector_Sub1.anInt1844 = (Class37_Sub9_Sub4.anIntArray2981[Class37_Sub9_Sub17.anInt3225]);
			}
			if (i == ByteVector_Sub1.anInt1844) {
				if ((i_4_ ^ 0xffffffff) < -1) {
					i_4_--;
					Applet_Sub1.aClass19_38.method208(1, 0, 122,
							Class83.byteVector.buffer);
					ByteVector_Sub1.anInt1844 = (Class83.byteVector.buffer[0] & 0xff);
				} else
					return false;
			}
			if ((ByteVector_Sub1.anInt1844 ^ 0xffffffff) == 1) {
				if (i_4_ <= 1)
					return false;
			...
			if (ByteVector_Sub1.anInt1844 > i_4_)
				return false;
			Class83.byteVector.currentOffset = 0;
			Applet_Sub1.aClass19_38.method208(ByteVector_Sub1.anInt1844, 0, 122,
					(Class83.byteVector.buffer));
			...
			if(Class37_Sub9_Sub17.anInt3225 == 0) {
				...
				int followType = Class83.byteVector.getUnsignedByte(117);
			...
			if (Class37_Sub9_Sub17.anInt3225 == 237) {
				RSString rSString = Class83.byteVector
						.getRS2String();
				Object[] objects = new Object[1 + rSString.method172((byte) 38)];
				for (int i_5_ = -1 + rSString.method172((byte) 38); i_5_ >= 0; i_5_--) {
					if (rSString.method161(i_5_, 56) == 115)
						objects[1 + i_5_] = Class83.byteVector
								.getRS2String();
					else
						objects[1 + i_5_] = new Integer(
								Class83.byteVector.getInt(-62));
				}
			...
			if (Class37_Sub9_Sub17.anInt3225 == 30) {
				Class37_Sub4_Sub12.anInt2783 = Class83.byteVector
						.getUnsignedByte(117);
				Class37_Sub9_Sub17.anInt3225 = -1;
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -237) {
				int i_7_ = Class83.byteVector.getInt(-56);
			...
			if (Class37_Sub9_Sub17.anInt3225 == 163) {
				Class50.anInt1028 = Class83.byteVector
						.getUnsignedByte(117);
				Class65.anInt1231 = Class83.byteVector
						.method967(i + 256);
				while (Class83.byteVector.currentOffset < ByteVector_Sub1.anInt1844) {
					Class37_Sub9_Sub17.anInt3225 = Class83.byteVector
							.getUnsignedByte(126);
				...
				if (rSString.method176(Class36.aClass16_807, (byte) -124)) {
					...
					if (!bool && (Class52_Sub1.anInt2303 ^ 0xffffffff) == -1)
						Class37_Sub4_Sub7_Sub1_Sub1.method505(class16_8_, 4,
								(Class88.aClass16_1607), (byte) 120);
					...
					if (!bool && Class52_Sub1.anInt2303 == 0)
						Class37_Sub4_Sub7_Sub1_Sub1.method505(class16_10_, 8,
								(Class89.aClass16_1610), (byte) 123);
					...
					if (!bool && Class52_Sub1.anInt2303 == 0)
						Class37_Sub4_Sub7_Sub1_Sub1.method505(class16_18_, 10,
								Class37_Sub9_Sub8.aClass16_3045, (byte) -104);
				}
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			}
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -23) {
				int i_20_ = Class83.byteVector.getInt(-34);
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(i_20_, 4096);
				rSInterface.anInt408 = 3;
				rSInterface.anInt369 = Class37_Sub23.aClass37_Sub4_Sub7_Sub1_Sub2_2234.aClass29_3985
						.method268(4);
				Class73.refreshInterface(rSInterface, i);
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			}
			...
			if (Class37_Sub9_Sub17.anInt3225 == 35) {
				...
				long l_26_ = (long) Class83.byteVector
						.getTriByte(-26256544);
				int i_27_ = Class83.byteVector.getUnsignedByte(119);
...
//				}
			...
			if (Class37_Sub9_Sub17.anInt3225 == 128) {
				int i_31_ = (Class83.byteVector.currentOffset - -ByteVector_Sub1.anInt1844);
				...
				while (i_33_-- > 0) {
					int i_35_ = Class83.byteVector.getInt(-57);
					int i_36_ = Class83.byteVector
							.getUnsignedShort();
					int i_37_ = Class83.byteVector.getUnsignedByte(124);
					Class37_Sub6 class37_sub6 = ((Class37_Sub6) Class76.aClass13_1423
							.method100((byte) 97, (long) i_35_));
					if (class37_sub6 != null && i_36_ != class37_sub6.anInt1884) {
						Class37_Sub11_Sub1.method992(-1494101117, class37_sub6,
								true);
						class37_sub6 = null;
					}
				...
				for (Class37_Sub6 class37_sub6 = ((Class37_Sub6) Class76.aClass13_1423
						.method94(i + 119)); class37_sub6 != null; class37_sub6 = (Class37_Sub6) Class76.aClass13_1423
						.method102((byte) 95)) {
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -11) {
				...
				if ((i_43_ ^ 0xffffffff) != (Class37_Sub23.anIntArray2237[i_44_] ^ 0xffffffff)) {
					Class37_Sub23.anIntArray2237[i_44_] = i_43_;
					Class65.method1183(i_44_, (byte) -3);
				}
				Class37_Sub9_Sub1.anIntArray2918[Class37_Sub4_Sub7.method490(
						Class24.anInt615++, 31)] = i_44_;
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			}
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -180) {
				...
				Class37_Sub9_Sub11.anInt3106 = Class83.byteVector
						.getUnsignedShort();
				Class37_Sub8.anInt1932 = Class83.byteVector
						.getUnsignedByte(i + 120);
				Class76.anInt1438 = Class83.byteVector
						.getUnsignedByte(120);
				if (Class76.anInt1438 >= 100) {
					Class37_Sub6.anInt1888 = Class37_Sub4_Sub11.anInt2697 * 128 + 64;
					...
					Class37_Sub25.anInt2286 = (RSString.method153(
							...
							Class37_Sub6.anInt1888, Class19.anInt483) - Class37_Sub9_Sub11.anInt3106);
				}
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			}
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -175) {
				int i_45_ = Class83.byteVector.getInt(i + -97);
				Class37_Sub6 class37_sub6 = ((Class37_Sub6) Class76.aClass13_1423
						.method100((byte) 88, (long) i_45_));
				if (class37_sub6 != null)
					Class37_Sub11_Sub1.method992(-1494101117, class37_sub6,
							true);
...
//				System.out.println(i_50_);
				...
				if ((Class37_Sub23.anIntArray2237[i_49_] ^ 0xffffffff) != (i_50_ ^ 0xffffffff)) {
					Class37_Sub23.anIntArray2237[i_49_] = i_50_;
					Class65.method1183(i_49_, (byte) -3);
				}
				Class37_Sub9_Sub1.anIntArray2918[Class37_Sub4_Sub7.method490(
						31, Class24.anInt615++)] = i_49_;
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			}
			if (Class37_Sub9_Sub17.anInt3225 == 168) {
				Class50.anInt1028 = Class83.byteVector
						.getUnsignedByte(i ^ ~0x75);
				Class65.anInt1231 = Class83.byteVector
						.method952((byte) 11);
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			...
			if (Class37_Sub9_Sub17.anInt3225 == 15) {
				Class37_Sub9_Sub24.anInt3361 = Class83.byteVector
						.getUnsignedByte(124);
				Class8.anInt165 = Class83.byteVector.getUnsignedByte(i
						^ ~0x7f);
			...
			if (Class37_Sub9_Sub17.anInt3225 == 114) {
				...
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(i_52_, 4096);
				int i_56_ = (i_54_ << 1879056515)
						+ ((i_55_ << -1077140757) + (i_53_ << 1955750899));
				if (i_56_ != rSInterface.anInt442) {
					rSInterface.anInt442 = i_56_;
			...
			if (Class37_Sub9_Sub17.anInt3225 == 127) {
				...
				int i_58_ = Class83.byteVector.getInt(i + -23);
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(i_58_, 4096);
				if (rSInterface.anInt408 != 2
						|| (i_57_ ^ 0xffffffff) != (rSInterface.anInt369 ^ 0xffffffff)) {
					rSInterface.anInt408 = 2;
					rSInterface.anInt369 = i_57_;
					Class73.refreshInterface(rSInterface, i);
				}
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -83) {
				for (int i_59_ = 0; i_59_ < Class37_Sub23.anIntArray2237.length; i_59_++) {
					if ((Class80.anIntArray1503[i_59_] ^ 0xffffffff) != (Class37_Sub23.anIntArray2237[i_59_] ^ 0xffffffff)) {
						Class37_Sub23.anIntArray2237[i_59_] = Class80.anIntArray1503[i_59_];
						Class65.method1183(i_59_, (byte) -3);
						Class37_Sub9_Sub1.anIntArray2918[Class37_Sub4_Sub7
								.method490(31, Class24.anInt615++)] = i_59_;
					}
				}
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -108) {
				...
				int i_61_ = Class83.byteVector
						.method942(i ^ ~0x2);
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(i_60_, 4096);
				if (i_61_ != rSInterface.anInt390 || i_61_ == -1) {
					rSInterface.anInt390 = i_61_;
			...
			if (Class37_Sub9_Sub17.anInt3225 == 117) {
				...
				int i_65_ = Class83.byteVector.getUnsignedByte(116);
				boolean bool = false;
...
//				}
				...
				if (!bool && (Class52_Sub1.anInt2303 ^ 0xffffffff) == -1) {
					...
					if ((i_65_ ^ 0xffffffff) != -3
						...
						Class37_Sub4_Sub7_Sub1_Sub1
								.method505((Class37_Sub9_Sub27.method881(i
										^ ~0x6c, new RSString[] {
										Class42.aClass16_917,
										Class37_Sub4_Sub13.method708(37, l)
			...
			if (Class37_Sub9_Sub17.anInt3225 == 187) {
				int i_68_ = Class83.byteVector.getInt(-44);
				...
				if ((i_68_ ^ 0xffffffff) > -1)
					...
					rSInterface = Class37_Sub9_Sub14.getInterface(i_68_, i + 4097);
				while ((Class83.byteVector.currentOffset ^ 0xffffffff) > (ByteVector_Sub1.anInt1844 ^ 0xffffffff)) {
					int i_70_ = Class83.byteVector.method961(255);
					int i_71_ = Class83.byteVector.getUnsignedShort();
					int i_72_ = 0;
					if (i_71_ != 0) {
						i_72_ = Class83.byteVector.getUnsignedByte(125);
					...
					if (rSInterface != null
							&& (i_70_ ^ 0xffffffff) <= -1
							&& ((rSInterface.anIntArray356.length ^ 0xffffffff) < (i_70_ ^ 0xffffffff))) {
						rSInterface.anIntArray356[i_70_] = i_71_;
						rSInterface.anIntArray422[i_70_] = i_72_;
					}
					Class52_Sub1
							.method1131(i_72_, i_70_, i_69_, 25, i_71_ + -1);
				}
				if (rSInterface != null)
					Class73.refreshInterface(rSInterface, -1);
				Class37_Sub9_Sub15.method822((byte) 96);
				Class37_Sub9.anIntArray1964[Class37_Sub4_Sub7.method490(
						Class37_Sub4_Sub8.anInt2642++, 31)] = Class37_Sub4_Sub7
						.method490(32767, i_69_);
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			}
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -45) {
				int i_73_ = Class83.byteVector.getUnsignedByte(117);
				int i_74_ = Class83.byteVector.getUnsignedByte(i
						^ ~0x77);
				int i_75_ = Class83.byteVector.getUnsignedByte(i
						^ ~0x7a);
				int i_76_ = Class83.byteVector.getUnsignedByte(123);
				...
				Landscape.anIntArray1126[i_73_] = i_77_;
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			}
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -174) {
				RSInterface.anInt340 = ByteVector_Sub1.anInt1844 / 8;
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -256) {
				...
				int i_80_ = Class83.byteVector
						.method979(-52131576);
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(i_80_, 4096);
				if (rSInterface != null && (rSInterface.anInt354 ^ 0xffffffff) == -1) {
					if (-rSInterface.anInt353 + rSInterface.anInt348 < i_79_)
						i_79_ = rSInterface.anInt348 - rSInterface.anInt353;
					if ((i_79_ ^ 0xffffffff) > -1)
						i_79_ = 0;
					if (i_79_ != rSInterface.anInt432) {
						rSInterface.anInt432 = i_79_;
						Class73.refreshInterface(rSInterface, i);
					}
				}
				Class37_Sub9_Sub17.anInt3225 = -1;
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -57) {
				...
				Class37_Sub4_Sub4.aByte2573 = Class83.byteVector
						.method982((byte) 107);
				int i_87_ = Class83.byteVector.getUnsignedByte(125);
				if (i_87_ == 255) {
					Class37_Sub9_Sub17.anInt3225 = -1;
					return true;
				}
				...
				for (int i_88_ = 0; (Class35.anInt783 ^ 0xffffffff) < (i_88_ ^ 0xffffffff); i_88_++) {
					...
					class37_sub18s[i_88_].aLong818 = Class83.byteVector
							.getLong(false);
					class37_sub18s[i_88_].aClass16_2197 = Class37_Sub4_Sub13
							.method708(37, class37_sub18s[i_88_].aLong818);
					class37_sub18s[i_88_].anInt2192 = Class83.byteVector
							.getUnsignedShort();
					class37_sub18s[i_88_].aByte2194 = Class83.byteVector
							.method982((byte) 102);
					if ((Class37_Sub9_Sub34.aLong3556 ^ 0xffffffffffffffffL) == (class37_sub18s[i_88_].aLong818 ^ 0xffffffffffffffffL))
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -168) {
				...
				if ((Class6.anInt146 ^ 0xffffffff) <= -101) {
					...
					int i_93_ = (RSString.method153(Class37_Sub9_Sub1.anInt2916,
							-169496123, i_91_, i_92_) - Class37_Sub9_Sub22.anInt3333);
			...
			if (Class37_Sub9_Sub17.anInt3225 == 158) {
				...
				Class37_Sub9.anIntArray1964[Class37_Sub4_Sub7.method490(31,
						Class37_Sub4_Sub8.anInt2642++)] = Class37_Sub4_Sub7
			...
			if (Class37_Sub9_Sub17.anInt3225 == 200) {
				...
				int i_103_ = Class83.byteVector.getUnsignedByte(i
						^ ~0x76);
				RSString rSString = Class37_Sub4_Sub13.method708(37, l)
						.method164(i + 71);
				for (int i_104_ = 0; (Class9.anInt173 ^ 0xffffffff) < (i_104_ ^ 0xffffffff); i_104_++) {
					if (l == Class71.aLongArray1360[i_104_]) {
						if ((i_102_ ^ 0xffffffff) != (Class9.anIntArray176[i_104_] ^ 0xffffffff)) {
							Class9.anIntArray176[i_104_] = i_102_;
							if (i_102_ > 0)
								Class37_Sub4_Sub7_Sub1_Sub1
										.method505(
												Class37_Sub9_Sub8.aClass16_3045,
				...
				if (rSString != null && Class9.anInt173 < 200) {
					Class71.aLongArray1360[Class9.anInt173] = l;
					Class69.aClass16Array1342[Class9.anInt173] = rSString;
					Class9.anIntArray176[Class9.anInt173] = i_102_;
					Class37_Sub9_Sub31.anIntArray3484[Class9.anInt173] = i_103_;
					Class9.anInt173++;
				}
				Class37_Sub9_Sub32.anInt3509 = Class83.anInt1515;
				boolean bool = false;
				int i_105_ = Class9.anInt173;
				while (i_105_ > 0) {
					bool = true;
					i_105_--;
					for (int i_106_ = 0; (i_105_ ^ 0xffffffff) < (i_106_ ^ 0xffffffff); i_106_++) {
						if ((((anInt3272 ^ 0xffffffff) != (Class9.anIntArray176[i_106_] ^ 0xffffffff)) && (Class9.anIntArray176[1 + i_106_] ^ 0xffffffff) == (anInt3272 ^ 0xffffffff))
								|| (Class9.anIntArray176[i_106_] == 0 && Class9.anIntArray176[1 + i_106_] != 0)) {
							bool = false;
							int i_107_ = Class9.anIntArray176[i_106_];
							Class9.anIntArray176[i_106_] = Class9.anIntArray176[i_106_ + 1];
							Class9.anIntArray176[1 + i_106_] = i_107_;
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -154) {
				int i_111_ = Class83.byteVector.getInt1(i
						^ ~0x1fff);
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(i_111_, 4096);
				for (int i_112_ = 0; rSInterface.anIntArray356.length > i_112_; i_112_++) {
					rSInterface.anIntArray356[i_112_] = -1;
					rSInterface.anIntArray356[i_112_] = 0;
				}
				Class73.refreshInterface(rSInterface, -1);
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			...
			if (Class37_Sub9_Sub17.anInt3225 == 196) {
				Class37_Sub9_Sub15.method822((byte) 96);
				int i_113_ = Class83.byteVector.getUnsignedByte(118);
				int i_114_ = Class83.byteVector
						.getInt2(i + 126);
				int i_115_ = Class83.byteVector.getUnsignedByte(117);
				...
				Class37_Sub9_Sub30.anIntArray3475[Class37_Sub4_Sub7.method490(
						31, Class37_Sub9_Sub3.anInt2946++)] = i_113_;
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			}
			...
			if (Class37_Sub9_Sub17.anInt3225 == 33) {
				...
				int i_118_ = Class83.byteVector.getInt1(i
						^ ~0x1fff);
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(i_118_, 4096);
				if ((rSInterface.anInt408 ^ 0xffffffff) != -2
						|| rSInterface.anInt369 != i_117_) {
...
//				return true;
				...
				int i_119_ = Class83.byteVector.getInt(-31);
				int i_120_ = Class83.byteVector.getUnsignedShort();
				RSInterface rSInterface;
				if ((i_119_ ^ 0xffffffff) > -1)
					rSInterface = null;
				else
					rSInterface = Class37_Sub9_Sub14.getInterface(i_119_, i + 4097);
				if (rSInterface != null) {
					for (int i_121_ = 0; ((i_121_ ^ 0xffffffff) > (rSInterface.anIntArray356.length ^ 0xffffffff)); i_121_++) {
						rSInterface.anIntArray356[i_121_] = 0;
						rSInterface.anIntArray422[i_121_] = 0;
					}
				}
				if (i_119_ < -70000)
					i_120_ += 32768;
				...
				for (int i_123_ = 0; (i_123_ ^ 0xffffffff) > (i_122_ ^ 0xffffffff); i_123_++) {
					...
					if (rSInterface != null
							&& ((i_123_ ^ 0xffffffff) > (rSInterface.anIntArray356.length ^ 0xffffffff))) {
						rSInterface.anIntArray356[i_123_] = i_125_;
						rSInterface.anIntArray422[i_123_] = i_124_;
					}
					Class52_Sub1.method1131(i_124_, i_123_, i_120_, 64, -1
							+ i_125_);
				}
				if (rSInterface != null)
					Class73.refreshInterface(rSInterface, -1);
...
//				System.out.println(i_127_);
				//interface id
				int i_128_ = Class83.byteVector.getInt(-89);
...
//				System.out.println(i_129_);
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(i_128_, 4096);
				if (rSInterface.anInt319 != i_126_
						|| (rSInterface.anInt405 ^ 0xffffffff) != (i_129_ ^ 0xffffffff)
						|| (i_127_ ^ 0xffffffff) != (rSInterface.anInt387 ^ 0xffffffff)) {
					rSInterface.anInt405 = i_129_;
					rSInterface.anInt319 = i_126_;
					rSInterface.anInt387 = i_127_;
					Class73.refreshInterface(rSInterface, -1);
				}
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			...
			if (Class37_Sub9_Sub17.anInt3225 == 184) {
				boolean bool = ((Class83.byteVector
						.method952((byte) -113) ^ 0xffffffff) == -2);
				int i_130_ = Class83.byteVector.getInt(-83);
				RSInterface rSInterface = Class37_Sub9_Sub14
						.getInterface(i_130_, i + 4097);
				if (bool != rSInterface.aBoolean445) {
					rSInterface.aBoolean445 = bool;
					Class73.refreshInterface(rSInterface, -1);
				}
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			...
			if (Class37_Sub9_Sub17.anInt3225 == 4) {
				int i_131_ = Class83.byteVector.getUnsignedByte(i
						^ ~0x7a);
				if (Class83.byteVector.getUnsignedByte(119) != 0) {
			...
			if (Class37_Sub9_Sub17.anInt3225 == 32) {
				...
				if (bool) {
					...
					for (i_135_ = 0; i_135_ < Class35.anInt783; i_135_++) {
						if (((Class14.aClass37_Sub18Array240[i_135_].aLong818 ^ 0xffffffffffffffffL) == (l ^ 0xffffffffffffffffL))
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -244) {
				...
				int i_140_ = Class83.byteVector.getUnsignedByte(126);
			...
			if (Class37_Sub9_Sub17.anInt3225 == 178) {
				...
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(i_144_, i + 4097);
				Class37_Sub9_Sub17.anInt3225 = -1;
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -134) {
				...
				int i_147_ = Class83.byteVector.getInt(-28);
				...
				for (int i_149_ = i_148_; i_149_ <= i_146_; i_149_++) {
					...
					Class37 class37 = Class62.aClass13_1177.method100(
							(byte) 117, l);
					if (class37 != null)
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -170) {
				...
				for (int i_152_ = Class50.anInt1028; i_152_ < 8 + Class50.anInt1028; i_152_++) {
					for (int i_153_ = Class65.anInt1231; ((Class65.anInt1231 + 8 ^ 0xffffffff) < (i_153_ ^ 0xffffffff)); i_153_++) {
				...
				for (Class37_Sub2 class37_sub2 = ((Class37_Sub2) Class37_Sub9_Sub28.aClass58_3427
					...
					if (((Class50.anInt1028 ^ 0xffffffff) >= (class37_sub2.anInt1836 ^ 0xffffffff))
							...
							&& ((Class65.anInt1231 ^ 0xffffffff) >= (class37_sub2.anInt1829 ^ 0xffffffff))
			...
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -232) {
				...
				RSString rSString = Class83.byteVector
						.getRS2String();
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(interfaceSet, 4096);
				if (!rSString.equalsRSString(-107, rSInterface.interfaceString)) {
...
//				writer.close();
			...
			if (Class37_Sub9_Sub17.anInt3225 == 76) {
				...
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(i_156_, 4096);
				int i_158_ = rSInterface.anInt397 - -i_157_;
				int i_159_ = rSInterface.anInt326 + i_155_;
				if ((rSInterface.anInt329 ^ 0xffffffff) != (i_159_ ^ 0xffffffff)
						|| (rSInterface.anInt415 ^ 0xffffffff) != (i_158_ ^ 0xffffffff)) {
					rSInterface.anInt415 = i_158_;
					rSInterface.anInt329 = i_159_;
					Class73.refreshInterface(rSInterface, -1);
				}
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			...
			if (Class37_Sub9_Sub17.anInt3225 == 57) {
				...
				Class37_Sub4_Sub7_Sub1_Sub1
						.method505(Class37_Sub4_Sub13.method708(37, l)
								.method164(70), 6, rSString, (byte) -87);
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			}
			if ((Class37_Sub9_Sub17.anInt3225 ^ 0xffffffff) == -250) {
				...
				if (i_162_ == 65535)
					i_162_ = -1;
				RSInterface rSInterface = Class37_Sub9_Sub14.getInterface(i_160_, 4096);
				if (rSInterface.aBoolean374) {
					rSInterface.anInt368 = i_161_;
					rSInterface.anInt367 = i_162_;
					...
					if ((rSInterface.anInt441 ^ 0xffffffff) < -1)
						rSInterface.anInt387 = rSInterface.anInt387 * 32
								/ rSInterface.anInt441;
					rSInterface.anInt359 = class37_sub4_sub1.anInt2517;
					Class73.refreshInterface(rSInterface, -1);
				} else {
					if (i_162_ == -1) {
						rSInterface.anInt408 = 0;
						Class37_Sub9_Sub17.anInt3225 = -1;
						return true;
					}
					RSItem class37_sub4_sub1 = Class46.loadItem(
							i_162_, (byte) 120);
					rSInterface.anInt387 = 100 * class37_sub4_sub1.modelZoom
							/ i_161_;
					rSInterface.anInt319 = class37_sub4_sub1.modelRotation1;
					rSInterface.anInt369 = i_162_;
					rSInterface.anInt405 = class37_sub4_sub1.modelRotation2;
					rSInterface.anInt408 = 4;
					Class73.refreshInterface(rSInterface, i);
				}
				Class37_Sub9_Sub17.anInt3225 = -1;
				return true;
			...
			Class37_Sub9_Sub3
					.method768(
							...
							("T1 - " + Class37_Sub9_Sub17.anInt3225 + ","
									...
									+ Class37_Sub9_Sub27.anInt3418 + " - " + ByteVector_Sub1.anInt1844),
							null);
			...
			for (int i_163_ = 0; i_163_ < ByteVector_Sub1.anInt1844 && i_163_ < 50; i_163_++)
				string += (Class83.byteVector.buffer[i_163_] + ",");
			...
			for (int i_178_ = 1; i_176_ - 1 > i_178_; i_178_++) {
				...
				for (int i_180_ = i_179_; (i_180_ ^ 0xffffffff) > -129; i_180_++) {
					...
					if (i_181_ != 0) {
						...
						Class56.aClass37_Sub4_Sub9_Sub3_1095.anIntArray3904[i_175_++] = ((Class37_Sub4_Sub7
								.method490((i_183_
				...
				i_174_ += Class42.aClass37_Sub4_Sub9_Sub3_923.anInt3903 + -128;
			}
			i_175_ = 0;
			...
			for (int i_186_ = 1; (i_186_ ^ 0xffffffff) > (-1 + i_176_ ^ 0xffffffff); i_186_++) {
				...
				for (int i_189_ = i_187_; (i_189_ ^ 0xffffffff) > -129; i_189_++) {
					...
					if (i_190_ == 0)
						...
						Class64.aClass37_Sub4_Sub9_Sub3_1212.anIntArray3904[i_175_++] = ((Class37_Sub4_Sub7
								.method490((i_192_
										* Class37_Sub4_Sub7.method490(65280,
