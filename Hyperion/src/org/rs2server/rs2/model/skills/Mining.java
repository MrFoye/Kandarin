...
public class Mining extends HarvestingAction {
	...
	public static enum Rock {
		 ...
		 * Coal ore.
		 */
		COAL(453, 30, 50, 50, 3, new int[] { 2096, 2097 }, new int[] { 450, 451 }),
		
		/**
		 * Mithril ore.
		 */
		MITHRIL(447, 55, 80, 200, 4, new int[] { 2102, 2103 }, new int[] { 450, 451 }),
		
		/**
		 * Adamantite ore.
		 */
		ADAMANTITE(449, 70, 95, 400, 6, new int[] { 2104, 2105 }, new int[] { 450, 451 }),
		
		/**
		 * Rune ore.
		 */
		RUNE(451, 85, 215, 1000, 8, new int[] { 2106, 2107 }, new int[] { 450, 451 })
