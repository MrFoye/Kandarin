...
public class ActionSender {
	...
	public ActionSender sendLogin() {
		...
		player.getActionSender().sendMessage("Please report all bugs on the forums at http://rs2-server.org, thank-you.");
		...
		player.getActionSender().sendMessage("Go to ::deeppk for multi-combat mayhem!");
